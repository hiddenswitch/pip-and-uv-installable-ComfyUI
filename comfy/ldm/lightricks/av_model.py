...
class BasicAVTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        if run_vx:
            ...
            vx.add_(self.attn2(rms_norm(vx), context=v_context, mask=attention_mask, transformer_options=transformer_options))
        ...
        if run_ax:
            ...
            ax.add_(self.audio_attn2(rms_norm(ax), context=a_context, mask=attention_mask, transformer_options=transformer_options))
