...
class LTXAVTEModel(torch.nn.Module):
    ...
    def load_sd(self, sd):
        ...
        sdo = state_dict_prefix_replace(sd, {"text_embedding_projection.aggregate_embed.": "text_embedding_projection.", "text_embedding_projection.": "text_embedding_projection."}, filter_keys=True)
        if len(sdo) == 0:
            sdo = sd
